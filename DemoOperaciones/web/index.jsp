        ...
        <div class="sty">
            <form method="post" name="frmOperacioes" id="frmOperaciones" action="operaciones">
                <fieldset>
                    ...
                    <input type="number" name="txtNumA" placeholder="N&uacute;mero a" step="any" value="0">
                    <input type="number" name="txtNumB" placeholder="N&uacute;mero b" step="any" value="0">
                    <input type="number" name="txtNumC" placeholder="N&uacute;mero c" step="any" style="display: none;" id="txtNumC" value="0">
                    ...
                    <select id="sltOperacion" name="sltOperacion">
                        <optgroup label="Operaciones b&aacute;sicas:">
                            ...
                            <option value="6">Ecuaci&oacute;n Cuadr&aacute;tica</option>
                        </optgroup>
                    </select>      
                </fieldset>
